...
This repository is organized for Streamlit Community Cloud deployment while
preserving the original project behavior and model assets.
"""
...
st.markdown(
    ...
    .title { text-align: center; color: #1E88E5; font-size: 40px; font-weight: bold; }
    .subtitle { text-align: center; color: gray; font-size: 18px; }
    .box { background-color: #F4F6F6; padding: 20px; border-radius: 10px; margin-top: 15px; }
    </style>
    """,
...
with right_col:
    ...
    selected_job = st.selectbox("Choose Job Role", list(JOB_DATABASE.keys()))
